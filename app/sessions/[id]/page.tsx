...
export default function OpportunityDetailPage() {
  ...
  if (!opportunity) {
    return <div className="container mx-auto px-4 py-8">機会が見つかりません</div>
  }
      ...
      <div className="px-4 py-6 space-y-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between py-3 border-b">
            ...
            <span>{opportunity.durationMinutes}分</span>
          </div>
          <div className="flex items-center justify-between py-3 border-b">
            <span className="text-muted-foreground flex items-center">
        ...
        {/* Host Message */}
        <div>
          <h2 className="text-lg font-semibold mb-4">機会をもらいたいこと</h2>
              ...
              <div className="border border-border rounded-lg p-4 hover:bg-accent transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">{opportunity.project.description}</p>
                  </div>
        ...
        {/* Related Articles */}
        {opportunity.relatedArticles && opportunity.relatedArticles.length > 0 && (
          <div>
